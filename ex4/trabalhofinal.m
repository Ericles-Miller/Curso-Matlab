%--------INSTRUÇÕES NECESSÁRIAS PARA O FUNCINAMENTO DO SOFTWARE-----------
%declare pelo terminal duas variaveis de nome: 'na' e 'nd' = 0
%declare pelo terminal duas matrizes de nome: matDisc = [] e 'matAluno = []
%em seguida execute o comando: save('dados_alunos.mat','na','nd','matDisc','matAluno');
%execute o programa trabalhofinal
% ----------------LEIA ACIMA AS INSTRUÇÕES-------------------------------------------------

function trabalhofinal()
    %clearvars;
    %close all;
